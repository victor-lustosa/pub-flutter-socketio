                    ...
                    return Align(
                      ...
                      child: Padding(
                        ...
                        child: Container(
                            ...
                            child: widget.instance.room.getMessagesList[index].getUser == ''? Center(child: Text('${widget.instance.room.getMessagesList[index].getTextMessage}')):
                            Text('${widget.instance.room.getMessagesList[index].getUser} - ${widget.instance.room.getMessagesList[index].getTextMessage}')
                        ),
                      ),
                    );
                  }
